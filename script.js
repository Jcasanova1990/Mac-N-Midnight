document.addEventListener("DOMContentLoaded", function () {
  ...
  function updateBosses() {
    ...
    function attackEnemy(enemy) {
        if (!enemy.isHit && isPlayerAttacking) {
    ...
    function isPlayerCloseToEnemy(enemy) {
        ...
        return playerDistance < 80; // Change the value (80) to the desired attack range
    }
    
    // Update the attack function to iterate through enemies and bosses and handle a single attack
    function attack() {
